...
<div class="ers-content ers-dashboard">
	    	...
	    	<div class="col-sm-6 col-md-6">
				<div class="panel become-a-member panel-full-warning">
	                ...
	                <div class="panel-body padding">
	                    ...
	                    <div class="buttons">
	                      <a href="#" class="btn btn-dark-warning col-sm-4 pull-left" >Join ERS</a>
	                      <a href="#" class="btn btn-default col-sm-4 pull-right">More...</a>
	                    </div>  
	                </div> 
	            </div>
	    	</div>
	...
	@include('newsfeed.newsfeed-api', array('class' => 'col-md-4'))
