var App = (function () {
  ...
  App.assemblies = function( ){
    ...
    $('#fullpage').fullpage({
        ...
        resize : false,
        sectionsColor : [assemblies1, assemblies2, assemblies1, assemblies2, assemblies2, assemblies1, assemblies2, assemblies1, assemblies1, assemblies2, assemblies1, assemblies2],
        paddingTop: '0px',
        paddingBottom: '0px',
